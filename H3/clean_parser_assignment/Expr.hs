...
value :: Expr -> Dictionary.T String Integer -> Integer -- Implemented
value (Num n) _ = n 
value (Var v) dict =
...
value (Div expr1 expr2) dict
        | value expr2 dict == 0 = error "error divition by zero"
        | otherwise = value expr1 dict `div` value expr2 dict
